...
const DispatchTable = ({ transactions, onViewDetails }) => {
  ...
  const sortedTransactions = [...transactions]?.sort((a, b) => {
    ...
    if (sortConfig?.key === 'customerNo') {
      return sortConfig?.direction === 'asc'
        ? (a?.customerNo || '').localeCompare(b?.customerNo || '', undefined, {
          numeric: true,
          sensitivity: 'base',
        })
        : (b?.customerNo || '').localeCompare(a?.customerNo || '', undefined, {
          numeric: true,
          sensitivity: 'base',
        });
    }

    if (sortConfig?.key === 'salespersonCode') {
      return sortConfig?.direction === 'asc'
        ? (a?.salespersonCode || '').localeCompare(b?.salespersonCode || '', undefined, {
          numeric: true,
          sensitivity: 'base',
        })
        : (b?.salespersonCode || '').localeCompare(a?.salespersonCode || '', undefined, {
          numeric: true,
          sensitivity: 'base',
        });
    }
